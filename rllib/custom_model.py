...
# TODO: Update this class to have a variable number of hidden layers
class Generalized_model_with_masking(TorchModelV2, nn.Module):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config,
        ...
        number_of_other_agents  = self.args.pool_size
        ...
        if self.args.reveal_other_agents_identity:
            self.layers['other_agents_identity']  = embedding_network(number_of_other_agents, embedding_size)
