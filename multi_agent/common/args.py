...
def get_args():
    ...
    parser.add_argument("--negotiation", type=bool, default=False, help="Whether the agents are allowed to enter into negotiation")
    ...
    parser.add_argument("--buffer-size", type=int, default=10240, help="number of transitions can be stored in buffer")
    ...
    parser.add_argument("--evaluate-episode-len", type=int, default=5, help="length of episodes for evaluating")
    ...
    args.save_dir = f'./results/{args.experiment_name}/{args.n_agents}_agents/{args.max_episode_len}_episode_len/negotiation_{args.negotiation}/models'
